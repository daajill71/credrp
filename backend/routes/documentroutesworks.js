...
router.post('/upload',
  ...
  async (req, res, next) => {
    try {
      // Step 6a: Get the unique client ID from the request body
      const { clientId } = req.body;

      // Step 6b: Access the uploaded files for different fields
      ...
      // Step 7: Create or update the document with the given clientId
